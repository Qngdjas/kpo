...
public class KPO25Test {
    ...
    /**
     * Тест с наибольшей последовательностью с 2 набором цифр одинаковой длины
     */
    @Test
    ...
    /**
     * Тест с наибольшей последовательностью с 3 набором цифр одинаковой длины
     */
    @Test
    ...
    /**
     * Тест с наибольшей последовательностью с пустым набором данных
     *
     */
    @Test
